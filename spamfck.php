<?php
	...
	Description: 3 way antispam protection.  This plugin: <strong>1.</strong> Add 3 hidden fields to Registration form and to Comments form, that only robots can see. Plus you can choose adding validation checkbox to forms. <strong>2.</strong> Add .htaccess direct access protection for comments file. <strong>3.</strong> Check time user spent on page and time when user send a form.
	Version: 1.2
